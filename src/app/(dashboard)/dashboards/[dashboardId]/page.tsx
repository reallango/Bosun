...
export default function CustomDashboardPage() {
    ...
    const { dashboard, widgets, isLoading, addWidget, updateLayout } = useDashboard(dashboardId);
    ...
    return (
        <div>
            ...
            <div className="p-6">
                ...
                <DashboardGrid dashboardId={dashboardId} widgets={widgets} onLayoutChange={updateLayout} editable />
